...
def gaussian(x, mi, var):
    ...
    for i in range(x):
        try:
            ...
            fx = 0
    fig = px.line(lista, width=900, height=500, title = 'Função de Densidade Normal', labels={'value': 'Probabilidade', 'index':'Eventos', 'variable':'Probabilidade'}, line_shape="spline")
